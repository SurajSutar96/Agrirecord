  ...
  const policyContent = {
    terms: (
      <div className="space-y-4 text-slate-600 text-sm leading-relaxed font-medium">
        ...
        <p>The Platform is owned by <strong>Aditya Jagtap</strong>, a company incorporated under the Companies Act, 1956 with its registered office at Latur, Maharashtra (hereinafter referred to as 'Platform Owner', 'we', 'us', 'our').</p>
    ...
    privacy: (
      <div className="space-y-4 text-slate-600 text-sm leading-relaxed font-medium">
        ...
        <div className="bg-slate-50 border border-slate-200 rounded-xl p-4 mt-4">
          ...
          <p className="text-xs text-slate-500 font-bold mt-1">Contact us: Phone: 7057107982</p>
    ...
    refund: (
      <div className="space-y-4 text-slate-600 text-sm leading-relaxed font-medium">
        ...
        <ol className="list-decimal list-outside ml-5 space-y-3 text-slate-500 font-bold text-xs">
          ...
          <li>Aditya Jagtap does not accept cancellation requests for perishable items like flowers, eatables, etc. However, the refund/replacement can be made if the user establishes that the quality of the product delivered is not good.</li>
        ...
        <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 text-xs text-amber-900 font-bold">
          In case of any refunds approved by Aditya Jagtap, it will take <strong>24 days</strong> for the refund to be processed to you.
        </div>
      </div>
    ),
  };
