...
Issued: ${issueDate}`;
  ...
  return (
    <div ref={containerRef} className="w-full flex flex-col items-center card-preview-container">
      ...
      >
        {/* FRONT CARD */}
        <div className="card-ratio bg-white h2c-bg-white shadow-[0_20px_50px_rgba(0,0,0,0.1)] rounded-none overflow-hidden relative card-pattern select-none" style={{ width: "600px", height: "380px", boxSizing: "border-box", border: "2px solid #000000" }}>
          {/* Watermark Logo */}
        ...
        {/* BACK CARD */}
        <div className="card-ratio bg-white h2c-bg-white shadow-[0_20px_50px_rgba(0,0,0,0.1)] rounded-none overflow-hidden p-5 flex flex-col relative card-pattern select-none" style={{ width: "600px", height: "380px", boxSizing: "border-box", border: "2px solid #000000" }}>
          {/* Watermark Logo */}
          <div className="absolute inset-0 flex items-center justify-center opacity-[0.08] pointer-events-none z-0">
            <img src={watermarkUrl} alt="Watermark" className="w-[360px] h-[360px] object-contain grayscale" />
          </div>
