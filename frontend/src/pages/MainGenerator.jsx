...
export default function MainGenerator({ user, onAuthSuccess, onUpdateCredits, onOpenRecharge }) {
  ...
  return (
    <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      {/* Hero Welcome banner */}
      <div className="mb-8 flex flex-col md:flex-row md:items-center md:justify-between border border-emerald-100 rounded-3xl bg-white p-6 shadow-xs gap-4 no-print">
        <div className="space-y-1">
          <h2 className="text-3xl font-black text-slate-800 tracking-tight leading-tight">
            Digital Kisan Card Generator
          </h2>
          <p className="text-sm font-semibold text-slate-400">
            Generate, preview, and download custom, printable Farmer ID Cards (Kisan Pehchan Patra).
          </p>
        </div>
        {!user && (
          <div className="flex items-center gap-2">
            <span className="p-2.5 bg-amber-50 rounded-2xl border border-amber-100 text-amber-800">
              <ShieldAlert className="w-5 h-5" />
            </span>
            <div className="flex flex-col pr-4">
              <span className="text-xs font-black text-amber-950 uppercase leading-none mb-1">
                Account Required
              </span>
            ...
            <button
              ...
              className="px-4 py-2.5 bg-[#064e3b] hover:bg-[#085a44] text-white font-black text-xs uppercase tracking-wider rounded-xl transition-all shadow-md cursor-pointer flex items-center gap-1.5"
            >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <form className="lg:col-span-6 bg-white border border-slate-200 rounded-3xl p-6 shadow-md space-y-6 no-print transition-all duration-300 relative">
        ...
        <div className="lg:col-span-6 flex flex-col gap-5">
          <div className="bg-white border border-slate-200 border-l-4 border-l-emerald-600 rounded-3xl p-6 shadow-sm no-print">
          ...
          <div className="bg-white border border-slate-200 rounded-3xl p-6 shadow-xs space-y-4 no-print">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <button
                ...
                className="py-3 bg-slate-100 hover:bg-slate-200 text-slate-800 text-xs font-black rounded-xl uppercase tracking-wider transition-all flex items-center justify-center gap-1.5 shadow-sm cursor-pointer border border-slate-200"
              >
              ...
              <button
                ...
                className="py-3 bg-emerald-800 hover:bg-emerald-900 text-white text-xs font-black rounded-xl uppercase tracking-wider transition-all flex items-center justify-center gap-1.5 shadow-md cursor-pointer"
              >
                <Download className="w-4 h-4 text-[#cddc39]" /> Download PDF
              </button>

              <button
                type="button"
                onClick={() => handleAction("print")}
                className="py-3 bg-[#064e3b] hover:bg-[#085a44] text-white text-xs font-black rounded-xl uppercase tracking-wider transition-all flex items-center justify-center gap-1.5 shadow-md cursor-pointer"
              >
